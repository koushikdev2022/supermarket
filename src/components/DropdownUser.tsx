...
//             Thomas Anree
//           </span>
//           <span className="block text-xs text-[#f58141]">Admin</span>
//         </span>
...
//             <Link
//               to="/profile"
//               className="flex items-center gap-2 text-sm font-normal duration-300 ease-in-out text-gray-600 hover:text-[#5ec0ff]"
//             >
...
//           </li>
//         </ul>
//         <button className="flex items-center gap-2 py-3 px-4 text-sm font-normal duration-300 ease-in-out text-gray-600 hover:text-[#5ec0ff]">
